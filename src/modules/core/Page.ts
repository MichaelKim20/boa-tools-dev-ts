...
export class Page {
    ...
    getMenu() {
        ...
        builder.append(
            '        <div data-role="panel" id="nav-panel" data-position-fixed="true" data-theme="a" data-display="overlay" >\n'
        );
        builder.append('			<ul data-role="listview" data-theme="a">\n');
        builder.append('				<li data-icon="delete"><a href="#" data-rel="close">Close</a></li> \n');
        builder.append(
            '				<div data-role="collapsible-set" data-theme="c" data-content-theme="a" data-inset="true" data-collapsed="false">\n'
        );

        if (this.group === 1) builder.append('					<div data-role="collapsible" data-collapsed="false" >\n');
        else builder.append('					<div data-role="collapsible" data-collapsed="true" >\n');
        ...
        if (this.group === 2) builder.append('					<div data-role="collapsible" data-collapsed="false" >\n');
        else builder.append('					<div data-role="collapsible" data-collapsed="true" >\n');
